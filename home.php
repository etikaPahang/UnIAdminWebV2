...
<body>
   ...
   <a href="events.php"> <button type="button" class="btn btn-primary btn-lg" style="width : 25%;margin: 10%; margin-left: 15%; margin-right: 2%; margin-top: 8% ">Events</button> 
    ...
    <a href="monthly.php"> <button type="button" class="btn btn-primary btn-lg" style="width : 25%;margin: 10%;  margin-left: 15%;  margin-right: 2%; margin-top: -5%"> Monthly Challange</button>
    </a>
